...
namespace Enemies.Components
{
    public class EnemySensor : MonoBehaviour
    {
        ...
        private void CheckVision()
        {
            ...
            var distance = dirToPlayer.magnitude;
            ...
            // Angle check
            var angle = Vector3.Angle(transform.forward, dirToPlayer.normalized);
            ...
            // Obstacle check
            var origin = transform.position + Vector3.up * 1.5f; // Eye height
